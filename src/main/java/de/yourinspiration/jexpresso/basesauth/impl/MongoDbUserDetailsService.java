...
public class MongoDbUserDetailsService implements UserDetailsService {
     ...
     * @param usernameField
     *            the name of the field for the username
     * @param passwordField
     *            the name of the field for the password
     * @param enabledField
     *            the name of the field for the enabled flag
     * @param authoritiesField
     *            the name of the field for the authority list
     */
